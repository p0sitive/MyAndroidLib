package com.example.myandroidlib.cache;
...
public class DiskLruCacheUtil {
    ...
    private static int appVersion = 1;//TDevice.getVersionCode();
     ...
     * @throws IOException 
     */
    public static void saveObject(Context context, Serializable ser, String key) throws IOException {
...
//            FileUtils.closeIO(oos);
     ...
     * @throws IOException 
     */
    public static Serializable readObject(Context context, String key) throws IOException {
